...
public class VehicleController {
    ...
    @Log(module = LogModule.VEHICLE, type = BusinessType.INSERT)
    @PostMapping("")
    ...
    @Log(module = LogModule.VEHICLE, type = BusinessType.QUERY)
    @GetMapping("")
    ...
    @Log(module = LogModule.VEHICLE, type = BusinessType.DELETE)
    @DeleteMapping("/{id}")
